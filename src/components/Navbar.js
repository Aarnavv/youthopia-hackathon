        ...
        <HashLink className="navbar-brand" to="#top">
          <div className="navbar-heading">
            ...
            <div className="navbar-heading-text">
              <span className="navbar-brand" id="header-name-static" href="Atlantis">Atlantis <br /> <span
                id="header-tag">A Smart Paradise</span></span>
            </div>
          </div>
        </HashLink>
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            <li className="nav-item">
              <NavLink to="/home">
                <span className="nav-link active" aria-current="page" href="/home">Home</span>
              </NavLink>
            </li>
            <li className="nav-item">
              <HashLink smooth to="/home/announcements">
                <span className="nav-link" id="about-link" href="/home/announcements">Announcements</span>
              </HashLink>
            </li>
              ...
              <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                <li>
                  <HashLink to="/home/suggestions">
                    <span className="dropdown-item" href="Make Suggestions!">Suggestions</span>
                  </HashLink>
                </li>
                <li>
                  <NavLink to="/home/complaints">
                    <span className="dropdown-item" id="latest-issue-home" href="Register Complaints!">Complaints</span>
                  </NavLink>
                </li>
                <li>
            ...
            <HashLink smooth to="#contact-us">
              <li className="nav-item">
                <span className="nav-link" id="contact-link">Contact Us</span>
              </li>
            </HashLink>
          </ul>
        </div>
